...
def getColumnOrder(table_name):
    ...
    if (table_name == "afus_owner"):
        column_order = ['owner_id', 'afus_oc_household_person_count', 'afus_oc_household_adult_count', 'afus_oc_household_child_count', 'afus_oc_primary_address_change', 'afus_oc_primary_address_change_date', 'afus_oc_primary_residence_ownership', 'afus_oc_primary_residence_ownership_other_description', 'afus_oc_primary_residence_state', 'afus_oc_primary_residence_census_division', 'afus_oc_primary_residence_time_percentage', 'afus_oc_secondary_residence', 'afus_oc_secondary_address_change', 'afus_oc_secondary_residence_change_date', 'afus_oc_secondary_residence_ownership', 'afus_oc_secondary_residence_ownership_other_description', 'afus_oc_secondary_residence_state', 'afus_oc_secondary_residence_time_percentage', 'afus_od_age_range_years', 'afus_od_max_education', 'afus_od_max_education_other_description', 'afus_od_annual_income_range_usd']
    return column_order
...
class PrimaryKeyGenerator:
    ...
    def __post_init__(self) -> None:
        ...
        elif self.table_name in ['hles_owner', 'afus_owner']:
    ...
    def generate_primary_key(self, row: dict[str, str]) -> str:
        ...
        elif self.table_name in {"hles_owner", "sample", "afus_owner"}:
            return row.pop(self.pk_name)
