...
/**
  * Container for the raw metadata pulled from RedCap data dictionary.
  *
  * @param fields metadata key-value attributes associated with the dog
  *               DO I ADD ALL THE DICT ITEMS HERE?
  */
case class RawMetadata(fields: Map[String, Array[String]]) {
