...
object HealthCondition extends LongEnum[HealthCondition] {
  ...
  // Skin conditions.
  case object DermoidCysts extends HealthCondition(301L, "Dermoid cysts", Skin, "dcysts", true, false)
  case object SpinaBifida extends HealthCondition(302L, "Spina bifida", Skin, "sp_bif", true, false)
  case object UmbilicalHernia extends HealthCondition(303L, "Umbilical hernia", Skin, "uh", true, false)
  case object Alopecia extends HealthCondition(304L, "Alopecia (hair loss)", Skin, "alo", false, true)
  case object AtopicDermatitis extends HealthCondition(305L, "Atopic dermatitis (atopy)", Skin, "ad", false, true)
  case object ChronicHotSpots extends HealthCondition(306L, "Chronic or recurrent hot spots", Skin, "chs", false, true)
  case object ChronicSkinInfections extends HealthCondition(307L, "Chronic or recurrent skin infections", Skin, "csi", false, true)
  case object ContactDermatitis extends HealthCondition(308L, "Contact dermatitis", Skin, "cd", false, true)
  case object DLE extends HealthCondition(309L, "Discoid lupus erythematosus (DLE)", Skin, "dle", false, true)
  case object FAD extends HealthCondition(310L, "Flea allergy dermatitis", Skin, "fad", false, true)
  case object Fleas extends HealthCondition(311L, "Fleas", Skin, "flea", false, true)
  case object FMA extends HealthCondition(312L, "Food or medicine allergies that affect the skin", Skin, "fma", false, true)
  case object Ichthyosis extends HealthCondition(313L, "Ichthyosis", Skin, "ich", false, true)
  case object LickGranuloma extends HealthCondition(314L, "Lick granuloma", Skin, "lg", false, true)
  case object NSD extends HealthCondition(315L, "Non-specific dermatosis", Skin, "nsd", false, true)
  case object PPP extends HealthCondition(316L, "Panepidermal pustular pemphigus (PPP)", Skin, "ppp", false, true)
  case object PNP extends HealthCondition(317L, "Paraneoplastic pemphigus (PNP)", Skin, "pnp", false, true)
  case object PE extends HealthCondition(318L, "Pemphigus erythematosus (PE)", Skin, "pe", false, true)
  case object PF extends HealthCondition(319L, "Pemphigus foliaceus (PF)", Skin, "pf", false, true)
  case object PV extends HealthCondition(320L, "Pemphigus vulgaris (PV)", Skin, "pv", false, true)
  case object Pododermatitis extends HealthCondition(321L, "Pododermatitis", Skin, "podo", false, true)
  case object Polymyositis extends HealthCondition(322L, "Polymyositis", Skin, "poly", false, true)
  case object Pruritis extends HealthCondition(323L, "Pruritis (itchy skin)", Skin, "pru", false, true)
  case object Pyoderma extends HealthCondition(324L, "Pyoderma or bacterial dermatitis", Skin, "pyo", false, true)
  case object SarcopticMange extends HealthCondition(325L, "Sarcoptic mange", Skin, "sm", false, true)
  case object SeasonalAllergies extends HealthCondition(326L, "Seasonal allergies", Skin, "sall", false, true)
  case object SebaceousAdenitis extends HealthCondition(327L, "Sebaceous adenitis", Skin, "sade", false, true)
  case object SebaceousCysts extends HealthCondition(328L, "Sebaceous cysts", Skin, "scys", false, true)
  case object Seborrhea extends HealthCondition(329L, "Seborrhea or seborrheic dermatitis (greasy skin)", Skin, "sd", false, true)
  case object SDM extends HealthCondition(330L, "Systemic demodectic mange", Skin, "sdm", false, true)
  case object SLE extends HealthCondition(331L, "Systemic lupus erythematosus (SLE)", Skin, "sle", false, true)
  case object Ticks extends HealthCondition(332L, "Ticks", Skin, "tick", false, true)
  case object OtherSkin extends HealthCondition(398L, "Other skin condition", Skin, "other", true, true, true, Some("hs_cg_skin_other"))
