...
object HealthCondition extends LongEnum[HealthCondition] {
  ...
  case object OtherEye
      extends HealthCondition(
        ...
        true,
        isOther = true,
        cgPrefixOverride = Some("eye_other")
      )
  ...
  case object OtherCG
      extends HealthCondition(
        ...
        false,
        isOther = true,
        cgPrefixOverride = Some("other"),
        computeGate = prefix => s"${prefix}_yn"
      )

  // Infections diseases.
  case object Anaplasmosis
      extends HealthCondition(1601L, "Anaplasmosis", Infection, "anaplasmosis", false, true)

  case object Aspergillosis
      extends HealthCondition(1602L, "Aspergillosis", Infection, "asperg", false, true)

  case object Babesiosis
      extends HealthCondition(1603L, "Babesiosis", Infection, "babesio", false, true)

  case object Blastomycosis
      extends HealthCondition(1604L, "Blastomycosis", Infection, "blastomy", false, true)

  case object Bordetella
      extends HealthCondition(
        1605L,
        """Bordetella and/or parainfluenza ("kennel cough")""",
        Infection,
        "bordetella",
        false,
        true
  ...
  case object Brucellosis
      extends HealthCondition(1606L, "Brucellosis", Infection, "brucellosis", false, true)

  case object Campylobacteriosis
      extends HealthCondition(1607L, "Campylobacteriosis", Infection, "campylo", false, true)
  ...
  case object Coccidioidiomycosis
      extends HealthCondition(1610L, "Coccidioidiomycosis", Infection, "ccdio", false, true)

  case object Cryptococcus
      extends HealthCondition(1611L, "Cryptococcus", Infection, "crypto", false, true)

  case object Ringworm
      extends HealthCondition(
        1612L,
  ...
  case object Ehrlichiosis
      extends HealthCondition(1614L, "Ehrlichiosis", Infection, "ehrlich", false, true)

  case object Fever
      extends HealthCondition(1615L, "Fever of unknown origin", Infection, "fever", false, true)

  case object GastroParasites
      extends HealthCondition(1616L, "Gastrointestinal parasites", Infection, "gp", false, true)
  ...
  case object Heartworms
      extends HealthCondition(1619L, "Heartworm infection", Infection, "hrtworm", false, true)

  case object Histoplasmosis
      extends HealthCondition(1620L, "Histoplasmosis", Infection, "histo", false, true)

  case object Hepatozoonosis
      extends HealthCondition(1621L, "Hepatozoonosis", Infection, "hepato", false, true)

  case object Hookworms
      extends HealthCondition(1622L, "Hookworms", Infection, "hkworm", false, true)
  ...
  case object Leishmaniasis
      extends HealthCondition(1625L, "Leishmaniasis", Infection, "leish", false, true)

  case object Leptospirosis
      extends HealthCondition(1626L, "Leptospirosis", Infection, "lepto", false, true)
  ...
  case object Mycobacterium
      extends HealthCondition(1629L, "Mycobacterium", Infection, "mycob", false, true)

  case object Parvovirus
      extends HealthCondition(1630L, "Parvovirus", Infection, "parvo", false, true)

  case object Plague
      extends HealthCondition(1631L, "Plague (Yersinia pestis)", Infection, "plague", false, true)
  ...
  case object Roundworms
      extends HealthCondition(1634L, "Roundworms", Infection, "rndworm", false, true)

  case object Salmonellosis
      extends HealthCondition(1635L, "Salmonellosis", Infection, "slmosis", false, true)

  case object SalmonPoison
      extends HealthCondition(1636L, "Salmon poisoning", Infection, "slmpois", false, true)

  case object Tapeworms
      extends HealthCondition(1637L, "Tapeworms", Infection, "tpworm", false, true)

  case object Toxoplasma
      extends HealthCondition(1638L, "Toxoplasma", Infection, "toxop", false, true)
  case object Tularemia extends HealthCondition(1639L, "Tularemia", Infection, "tular", false, true)

  case object Whipworms
      extends HealthCondition(1640L, "Whipworms", Infection, "whpworm", false, true)
