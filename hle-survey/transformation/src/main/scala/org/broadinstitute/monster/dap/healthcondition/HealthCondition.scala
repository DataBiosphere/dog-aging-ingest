...
object HealthCondition extends LongEnum[HealthCondition] {
  ...
  // Oral conditions.
  case object CleftLip extends HealthCondition(301L, "Cleft lip", Oral, cg = Some("cl_lip"))
  case object CleftPalate extends HealthCondition(302L, "Cleft palate", Oral, cg = Some("cl_pal"))
  case object MissingTeeth extends HealthCondition(303L, "Missing teeth", Oral, cg = Some("teeth"))
  case object DentalCalculus extends HealthCondition(304L, "Dental calculus (yellow build-up on teeth)", Oral, dx = Some("dc"))
  case object ExtractedTeeth extends HealthCondition(305L, "Extracted teeth", Oral, dx = Some("et"))
  case object FracturedTeeth extends HealthCondition(306L, "Fractured teeth", Oral, dx = Some("ft"))
  case object Gingivitis extends HealthCondition(307L, "Gingivitis (red, puffy gums)", Oral, dx = Some("ging"))
  case object MasticatoryMyositis extends HealthCondition(308L, "Masticatory myositis", Oral, dx = Some("mm"))
  case object OronasalFistula extends HealthCondition(309L, "Oronasal fistula", Oral, dx = Some("of"))
  case object Overbite extends HealthCondition(310L, "Overbite", Oral, dx = Some("ob"))
  case object RetainedDeciduousTeeth extends HealthCondition(311L, "Retained deciduous (baby) teeth", Oral, dx = Some("rd"))
  case object Sialocele extends HealthCondition(312L, "Sialocele", Oral, dx = Some("si"))
  case object Underbite extends HealthCondition(313L, "Underbite", Oral, dx = Some("ub"))
