...
object HealthConditionType extends LongEnum[HealthConditionType] {
  ...
  case object Eye
      extends HealthConditionType(1L, "Eye", Some(CgKey("eye")), Some(DxKey("eye", false)))
  ...
  case object Cardiac
      extends HealthConditionType(5L, "Heart/Cardiac", Some(CgKey("heart")), Some(DxKey("cardiac")))

  case object Respiratory
      extends HealthConditionType(6L, "Respiratory", Some(CgKey("resp")), Some(DxKey("respire")))

  case object Gastrointestinal
      extends HealthConditionType(7L, "Gastrointestinal", Some(CgKey("gastro")), Some(DxKey("gi")))

  case object Liver
      extends HealthConditionType(8L, "Liver", Some(CgKey("liver")), Some(DxKey("liver")))

  case object Kidney
      extends HealthConditionType(9L, "Kidney", Some(CgKey("kidney")), Some(DxKey("kidney")))

  case object Reproductive
      extends HealthConditionType(10L, "Reproductive", Some(CgKey("repro")), Some(DxKey("repro")))

  case object Orthopedic
  ...
  case object Endocrine
      extends HealthConditionType(13L, "Endocrine", Some(CgKey("endocr")), Some(DxKey("endo")))

  case object Hematopoietic
